...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "categoriesDefaultOther" : MessageLookupByLibrary.simpleMessage("Другое"),
    ...
    "emailVerificationNotice" : MessageLookupByLibrary.simpleMessage("Для активации учетной записи перейдите по ссылке, отправленной на указанный вами адрес электронной почты. Если вы не получили письмо, проверьте папку Спам или запросите новое письмо."),
    "emailVerificationResendButton" : MessageLookupByLibrary.simpleMessage("Отправить"),
    "emailVerificationTitle" : MessageLookupByLibrary.simpleMessage("Подтверждение электронной почты"),
    ...
    "form" : MessageLookupByLibrary.simpleMessage("Заполнить форму транзакции"),
    ...
    "loginCreateAccountButton" : MessageLookupByLibrary.simpleMessage("Зарегистрироваться"),
    "loginEmailLabelText" : MessageLookupByLibrary.simpleMessage("Адрес электронной почты"),
    "loginEmailValidatorEmpty" : MessageLookupByLibrary.simpleMessage("Укажите адрес электронной почты"),
    "loginEmailValidatorIncorrect" : MessageLookupByLibrary.simpleMessage("Укажите правильный адрес электронной почты"),
    "loginForgotPasswordButton" : MessageLookupByLibrary.simpleMessage("Забыли пароль?"),
    "loginNoAccountNotice" : MessageLookupByLibrary.simpleMessage("Нет учетной записи?"),
    "loginNoticeText" : MessageLookupByLibrary.simpleMessage("Авторизируйтесь, чтобы продолжить"),
    "loginPasswordLabelText" : MessageLookupByLibrary.simpleMessage("Пароль"),
    ...
    "noCategoriesExpensesDetailsMessage" : MessageLookupByLibrary.simpleMessage("В данном диапазоне нет трат!"),
    "noDataForCurrentDateRangeMessage" : MessageLookupByLibrary.simpleMessage("Отсутствуют данные для данного диапазона! Смените дату или добавьте новую транзакцию."),
    ...
    "searchExpensesAllCheckbox" : MessageLookupByLibrary.simpleMessage("Все"),
    "searchExpensesSearchTitle" : MessageLookupByLibrary.simpleMessage("Поиск"),
    ...
    "signUpApplyCredentialsButton" : MessageLookupByLibrary.simpleMessage("Зарегистрироваться"),
    "signUpCreateAccountHeader" : MessageLookupByLibrary.simpleMessage("Создайте учетную запись"),
    "signUpEmailLabelText" : MessageLookupByLibrary.simpleMessage("Электронная почта"),
    "signUpEmailValidatorEmpty" : MessageLookupByLibrary.simpleMessage("Укажите адрес электронной почты"),
    "signUpEmailValidatorIncorrect" : MessageLookupByLibrary.simpleMessage("Укажите правильный адрес электронной почты"),
    "signUpOTPContinueButton" : MessageLookupByLibrary.simpleMessage("Продолжить"),
    "signUpOTPNotice" : MessageLookupByLibrary.simpleMessage("На указанный номер будет отправлен одноразовый пароль"),
    "signUpOTPSentNotice" : MessageLookupByLibrary.simpleMessage("Введите одноразовый пароль, который был отправлен на номер:"),
    "signUpOTPValidatorIncorrect" : MessageLookupByLibrary.simpleMessage("Введите корректный пароль"),
    "signUpPageTitle" : MessageLookupByLibrary.simpleMessage("Регистрация"),
    "signUpPasswordConfirmationLabelText" : MessageLookupByLibrary.simpleMessage("Подтверждение пароля"),
    "signUpPasswordConfirmationValidatorNotMatch" : MessageLookupByLibrary.simpleMessage("Пароли не совпадают"),
    "signUpPasswordLabelText" : MessageLookupByLibrary.simpleMessage("Пароль"),
    "signUpPasswordValidatorEmpty" : MessageLookupByLibrary.simpleMessage("Введите пароль"),
    "signUpPhoneNumberLabelText" : MessageLookupByLibrary.simpleMessage("Номер телефона в международном формате"),
    "signUpPhoneNumberValidatorEmpty" : MessageLookupByLibrary.simpleMessage("Укажите номер телефона"),
    "signUpPhoneNumberValidatorIncorrect" : MessageLookupByLibrary.simpleMessage("Укажите корректный номер телефона"),
    "signUpUsernameLabelText" : MessageLookupByLibrary.simpleMessage("Имя пользователя"),
    "signUpUsernameValidatorEmpty" : MessageLookupByLibrary.simpleMessage("Укажите имя пользователя"),
    "signUpWrongNumberButton" : MessageLookupByLibrary.simpleMessage("Неправильный номер?"),
